...
\markright{Etude Pratique - Année 2013-2014} 
...
\FigureEPS{h,t,b,p}{4.5cm}{Images/blender.eps}{Logo de Blender}{fig:blender}
...
Parmi les différents aspects à réaliser pour ce projet, nous avons dû implémenter le passage d'un mode à l'autre, en gérant les animations correspondantes ; nous avons également dû implémenter les butées articulaires qui ne sont pas gérées par l'algorithme CCD, ou encore intégrer la méthode TECCC dans la section du mur d'escalade. 
